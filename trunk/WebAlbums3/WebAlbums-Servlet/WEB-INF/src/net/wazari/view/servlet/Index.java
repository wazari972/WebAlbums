...
public class Index extends HttpServlet {
    ...
    public void treatImpl(Page page,
            HttpServletRequest request,
            HttpServletResponse response,
            ViewSession vs)
            throws IOException {
    ...
    private void doWrite(HttpServletResponse response, XmlBuilder output, String xslFile, boolean isComplete, ViewSession vSession) {
