...
public class Dispatcher {
    private static ThemeLocal themeService;
    private static UserLocal userService;
    private static ChoixLocal choixService;
    private static AlbumLocal albumService;
    private static PhotoLocal photoService;
    private static TagLocal tagService;
    private static ImageLocal imageService;
    private static ConfigLocal configService;
    private static WebPageLocal webPageService;

    public static void treat(HttpServlet serv,
            Page page,
        ...
        String xslFile = null;
        ViewSession vSession = new ViewSessionImpl(request, response, serv.getServletContext()) ;
